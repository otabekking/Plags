  ...
  <div class="achievement">
    ...
    <div class="progress_main">
      <div class="progress_inner">
        <div class="circle">
          <img class="danger_imgs" :src="require('@/assets/Circler.svg')" />
          <div class="circle_inner">
            <div class="tick">
              <img class="danger_imgs" :src="require('@/assets/Ticker.svg')" />
            </div>
          </div>
        </div>
        <p class="danger_texter">Sarvardiplomishi. <span>pdf</span></p>
      </div>
    </div>
  </div>
</template>
